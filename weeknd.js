...
function startCountdown(eventId, eventDate) {
    ...
    let timer; // Declare timer variable first
...
// GNews API - reliable and works perfectly with GitHub Pages
const NEWS_API_URL = `https://gnews.io/api/v4/search?q=The%20Weeknd&lang=en&country=us&max=30&apikey=8613a856b2602921c5ba28eda6e22483`;
