...
function isDirectlyAboutWeeknd(article) {
    const keyword = /the weeknd/i;
    // Check if "The Weeknd" is in the title or in the first 200 chars of description
    return keyword.test(article.title) || (article.description && keyword.test(article.description.slice(0, 200)));
}
